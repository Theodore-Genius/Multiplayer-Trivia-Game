...
# On each client machine, connect using the server's LAN IP (or host's IPv4 if you are playing online):  
# If running through a VM, ensure the host's network adapter is set to “Bridged”, or it won't work   
